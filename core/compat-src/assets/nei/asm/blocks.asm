...
list d_drawSlot
GETSTATIC net/minecraft/client/gui/GuiScreen.field_146296_j : Lnet/minecraft/client/renderer/entity/RenderItem;
ALOAD 0
#GETFIELD net/minecraft/client/gui/inventory/GuiContainer.field_146289_q : Lnet/minecraft/client/gui/FontRenderer;
GETFIELD net/minecraft/client/gui/GuiScreen.field_146289_q : Lnet/minecraft/client/gui/FontRenderer;
ALOAD 0
#GETFIELD net/minecraft/client/gui/GuiScreen.field_146297_k : Lnet/minecraft/client/Minecraft;
GETFIELD net/minecraft/client/gui/GuiScreen.field_146297_k : Lnet/minecraft/client/Minecraft;
...
GETFIELD net/minecraft/entity/player/EntityPlayer.field_71071_by : Lnet/minecraft/entity/player/InventoryPlayer;
INVOKEVIRTUAL net/minecraft/entity/player/InventoryPlayer.func_70445_o ()Lnet/minecraft/item/ItemStack;
IFNONNULL L30
ALOAD 0
LCONST_0
